      ...
      window.addEventListener('load', function () {
        ...
        // Function to center chat window every time it opens
        ...
        // Auto-open after 2.5s unless manually clicked
// Auto-open after 2.5s unless manually clicked
setTimeout(function () {
  ...
  if (!manualClicked && chatToggleButton && !sessionStorage.getItem('chatAutoOpened')) {
    ...
    // Mark auto-open as done for this session
